---
title: "Lab 2 : git and Rstudio projects"
output:
  html_document:
    toc: true
    toc_depth: 4
...
### Syncing your GitHub repository with R Cloud

The process of syncing your GitHub repository with R Cloud is similar to using a local installation only when you create a new project select from Git Repo
...
__Inspect the history.__ For now, let's click on the *History* button in the Git tab, which will show the log of changes that occurred, and will be identical to what we viewed on GitHub. By clicking on each row of the history, you can see exactly what was added and changed in each of the two commits in this repository.
...
3. Create a Github repository "genomics-course"
...
5. Move your course files into the genomics-course directory. Move your .html files from the html folder to the main directory. Delete the html folder.
...
8. In the index.Rmd file add links to the .html file for Lab 1. 
9. For Lab 2 create a new .Rmd file that includes the content of Lab 1 with a set of references.
10. Create a bibliography file and put it in your data folder using a reference to the R package and/or R Markdown documents. Add the line to your YAML block at the beginning of your index.Rmd file.
...
11. Add a reference to your index.Rmd file. Don't forget to include the # REFERENCE block at the end of the file.
12. Knit your index.Rmd file. Test the resulting .html file to make sure the links work.
13. Embellish the index file (web page) with your own personal touches!
14. Add, Commit and Push these changes and files to the Github repo.
15. Check your Github page to make sure all is well.
16. Paste your Github page link into the Moodle Assignment page.

Here is the link to my [Evolutionary Genomics & Bioinformatics GitHub repository](https://github.com/jeffreyblanchard/EvoGeno) for an example of how to structure your files.