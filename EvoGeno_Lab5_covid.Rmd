...
states and territories. (Hint: Instead of the global time series use the US time series data in the same folder `time_series_covid19_deaths_US.csv` and `time_series_covid19_confirmed_US`) Format the table to look nice in the report by changing the number of rows in your graph and/or adjusting the height in the R code chunk header.
