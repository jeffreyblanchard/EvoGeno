...
In the [class GitHub repository](https://github.com/jeffreyblanchard/EvoGeno/) there is folder ShinyApps with examples of shiny apps using the COV-19 `Lab6x_example_5countries_app.R` and `Lab6x_example_map2_app.R` which you can down load to your computer. I have also put these examples on the RStudio Shiny server [Lab6x_example_5countries](https://jeffreyblanchard.shinyapps.io/example5countries/) and [Lab6x_example_map2](https://jeffreyblanchard.shinyapps.io/example5countries/). The map example may take a while to load depending on your connections.

## Exercises

There are no new exercises, only a extra credit challenge to go through the [Shiny tutorials](https://shiny.rstudio.com/tutorial/written-tutorial/lesson1/) and apply them to the Covid data set.
